...
\section{Descripción del CubeSat}
  ...
  \subsection{Descripción del equipo de soporte en tierra}
    \subsubsection{Interfaz web de monitoreo}
      Se desarrolló una interfaz web que permite la visualización de los datos recolectados por el CubeSat en diferido,
      es decir, una vez finalizado el vuelo. Esta herramienta permite explorar de manera visual las variables físicas
      medidas por los sensores a bordo, representándolas mediante gráficos en función del tiempo.  La interfaz fue
      desarrollada con HTML, CSS y JavaScript, la interpretacion y procesamiento de datos se realiza del lado del
      cliente, es decir, en la computadora que visualiza los datos para minimizar la carga de la computadora a bordo.
      Puede ser ejecutada localmente desde cualquier navegador moderno, sin la necesidad de conexion a internet ni la
      instalación de software adicional.

      De esta forma, en la estación terrena solo se requerirá una notebook con sistema operativo linux, 2GB de RAM y por
      lo menos 15GB de almacenamiento disponible, capacidades básicas para descargar los archivos y ejecutar la interfaz
      de monitoreo.
  ...
  \subsection{Criterios de Margenes}
    ...
    \subsubsection{Presupuesto Preliminar de Potencia}
      ...
      Puente H L298n        & 2 & 2    & $\textasciitilde 1$   & $\textasciitildei 2$ & 2 & 110 m  \\
      Módulo ADS1115 (ADC)  & 1 & 3.3  & 0.2 & 0.66 m    & 0.66 m & 0.04 m \\
