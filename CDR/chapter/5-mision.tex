...
\section{Descripción del CubeSat}
  ...
  \subsubsection{Thermal Regulation Unit (\acrshort{tru})}
    ...
    sistema sirve para generar condiciones térmicas específicas en los compartimientos que contienen los
  ...
  \subsection{Requerimientos}
    ...
    \begin{enumerate}
        ...
        \end{itemize}
            Además, debe ser capaz de mantener muestras a distintas temperaturas controladas (10\,°C, 37\,°C y 55\,°C).
    \end{enumerate}
  ...
  \subsection{Descripción del equipo de soporte en tierra}
    ...
    la \acrshort{obc}.  Esta última se encarga de servir los datos almacenados en formato CSV y de proveer los
