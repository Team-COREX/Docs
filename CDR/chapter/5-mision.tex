  ...
  \subsubsection{On-board Computer (\acrshort{obc})}
   ...
   El archivo CSV resultante cumple dos funciones clave:
    ...
    \subsubsection{Human-Machine Interface \acrshort{hmi}}
      ...
      El conector utilizado es un JST HX de 6 pines (macho en la \acrshort{obc} y hembra para el usuario) (fig. ~\ref{fig:conector-jst}),
      de los cuales 3 pines son leídos por la Raspberry Pi. Esos
      ...
      se puede ver una representación de la parte física del \acrshort{hmi}.

      \begin{figure}[H]
        \centering
        \includegraphics[width=0.8\linewidth]{image/conector/conector-jst.png}
      ...
      conectada a la parte física del \acrshort{hmi}, en los modos: \textit{prueba, pre lanzamiento y recuperación  de datos}.
      Esta interfaz web, es accesible gracias al punto de acceso WiFi
