...
\section{Objetivos Misión Secundaria}
  ...
  \subsection{Diseño experimental}
   ...
   \label{sec:procedimientos-prev-lanzamiento}
    ...
    aproximadamente $4\Celcius$, temperatura a la cual las muestras biológicas entran en un estado de inhibición metabólica
  ...
  \label{sec:procedimientos-ensayo}
   ...
   Adicionalmente, para analizar el proceso de enquistamiento —respuesta típica al estrés en Giardia lamblia—, se efectuarán ensayos
   de inmunofluorescencia y observaciones mediante microscopía de fluorescencia, buscando identificar vesículas específicas de
   enquistamiento como indicadores adicionales de estrés celular.
  ...
  \subsection{Criterios de Margenes}
    ...
    \subsubsection{Presupuesto Preliminar de Datos}
      ...
      \begin{itemize}
        ...
        \textbf{Parámetro} & \textbf{Frecuencia [Hz]} & \textbf{Muestras/4h} & \textbf{Tamaño [MB]} \\
        \hline
        Temperatura & 157   & 2,260,800  & $\approx$ 51.78     \\
        \end{tabular}
        }
...
\section{Secuencia de Operación}
  ...
  \begin{itemize}
    ...
    \item \textbf{Etapa 2:} Arranque del CubeSat.\\
      Una vez en el lugar de lanzamiento, se coloca la llave correspondiente en el \arcshort{hmi} físico para establecer el modo de Pre Lanzamiento, en el cual
