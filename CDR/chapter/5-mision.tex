...
\section{Secuencia de Operación}
  ...
  \begin{itemize}
    \item \textbf{Etapa 1:} Cultivo de muestras.
        48hs previo al dia de lanzamiento se procede con el cultivo de las muestras biológicas siguiento el procedimiento descripto en la sección  \ref{sec:procedimientos-prev-lanzamiento}.
   \item \textbf{Etapa 2:} Traslado de muestras.
    ...
    \item \textbf{Etapa 3:} Arranque del CubeSat.\\
      ...
      se inicializan todos los subsistemas. En esta etapa, el CubeSat será conectado a una fuente de alimentación externa para alcanzar el
    ...
    \item \textbf{Etapa 5:} Colocación de las Muestras.\\
      Una vez que la temperatura de la bahía de muestras esté estabilizada, se procede a destapar la
    ...
    \item \textbf{Etapa 9:} Traslado de muestras.\\
        Se trasladan las muestras al laboratorio donde serán analizadas, siguiendo mismo procedimiento descripto en la sección \ref{sec:procedimientos-prev-lanzamiento}
    ...
    \item \textbf{Etapa 11:} Procesamiento de datos.\\
      ...
      herramientas de software desarrolladas, con el fin buscar patrones y equipirarlos con los resultados de los ensayos
