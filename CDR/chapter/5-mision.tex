...
\section{Objetivos Misión Secundaria}
  ...
  \subsection{Diseño experimental}
   ...
   \subsection{Procedimientos previos al lanzamiento}
    ...
    reversible. El tiempo de traslado puede extenderse hasta 48 horas desde el momento de cultivo sin que esto afecte
    significativamente las condiciones de crecimiento del parásito.

  \subsection{Ensayos luego del lanzamiento}
   Los ensayos se llevarán a cabo posteriormente al lanzamiento y estarán a cargo de personal especializado del laboratorio
