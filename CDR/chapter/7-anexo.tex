...
\section{Cronograma Electrónica (Firmware)}
 ...
 \begin{figure}[H]
  ...
  \phantomsection
  \refstepcounter{section}
  \addcontentsline{toc}{section}{\numberline{\thesection}Dibujos Tecnicos}
    \includepdf[
      pages=-,
      pagecommand={\thispagestyle{plain}},
      addtotoc={1,subsection,1,{Estructura},anexo:planos.estructura},
      landscape=true
    ]{annex/structure_drawing.pdf}
    \includepdf[
      pages=-,
      pagecommand={\thispagestyle{plain}},
      addtotoc={1,subsection,1,{Modulo \acrshort{obc}},anexo:planos.obc},
      landscape=true
    ]{annex/OBC_drawing.pdf}
    \includepdf[
      pages=-,
      pagecommand={\thispagestyle{plain}},
      addtotoc={1,subsection,1,{Modulo \acrshort{pms}},anexo:planos.pms},
      landscape=true
    ]{annex/PMS_drawing.pdf}
    \includepdf[
      pages=-,
      pagecommand={\thispagestyle{plain}},
      addtotoc={1,subsection,1,{Modulo \acrshort{pu}},anexo:planos.pu},
      landscape=true
    ]{annex/Payload_drawing.pdf}
